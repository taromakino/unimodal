...
def main(args):
    ...
    x_dim = x_train_det.shape[1:]
    y_dim = y_train_det.shape[1]

    model_det = SSVAE(x_dim, args.hidden_dims, args.latent_dim, y_dim)
    model_union = SSVAE(x_dim, args.hidden_dims, args.latent_dim, y_dim)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hidden-dims", nargs="+", type=int, default=[64, 128, 256])
